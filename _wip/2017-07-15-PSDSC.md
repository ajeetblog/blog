...
Above diagram clearly shows the difference, traditional script is non-modular approach. Consider a case where we want to install AD and SQL server with one or more role, in traditional script 
