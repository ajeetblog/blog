...
Design a Virtual network, where you have NSG rules which only allow communication over port 80 and/ or 443 over the internet. Also, create a VNET endpoint for the web app. Add your web app inside the VNET endpoint. 
